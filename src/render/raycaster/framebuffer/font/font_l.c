    ...
    sfColor color)
{
    ...
    draw_rect(player, (sfVector4i_t){xy.x + scale_ch.x * 2, xy.y +
        scale_ch.x * 4, scale_ch.x, scale_ch.x}, color, scale_ch.y);
    draw_rect(player, (sfVector4i_t){xy.x + scale_ch.x * 2,
        xy.y + scale_ch.x * 3, scale_ch.x, scale_ch.x}, color, scale_ch.y);
}
